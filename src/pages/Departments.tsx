...
export default function Departments() {
  ...
  const teams = [
    {
      name: 'Coast',
      description: 'Reaching students from the coastal region with the gospel and building a strong coastal community',
    },
    {
      name: 'Ukambani',
      description: 'Ministering to students from the Ukambani region, fostering fellowship and spiritual growth',
    },
    {
      name: 'North-Rift',
      description: 'Serving students from North Rift with targeted outreach and discipleship programs',
    },
    {
      name: 'South-Rift',
      description: 'Building relationships and sharing Christ with students from the South Rift region',
    },
    {
      name: 'Western',
      description: 'Connecting with students from Western Kenya through culturally relevant ministry approaches',
    },
    {
      name: 'Nyanza',
      description: 'Empowering students from Nyanza region to live out their faith boldly on campus',
    },
    {
      name: 'Central',
      description: 'Creating a vibrant community for students from Central Kenya to grow in their faith',
    },
    {
      name: 'Nairobi',
      description: 'Engaging with students from Nairobi with dynamic worship and fellowship opportunities',
    },
  ];
                  ...
                  <div className="flex gap-3 mt-4">
                    {dept.groupUrl && (
                      <a
                        ...
                        className="flex-1 bg-accent hover:bg-accent-hover text-white px-4 py-2 rounded-lg text-center transition-colors flex items-center justify-center gap-2 text-sm"
                      >
                    ...
                    {dept.registrationUrl && (
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex-1 bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-lg text-center transition-colors text-sm"
                      >
                        Register
                      </a>
                    )}
